...
SALE_START = datetime(2026, 7, 3, 21, 0, 0, tzinfo=IST)
SALE_END = datetime(2026, 7, 3, 22, 0, 0, tzinfo=IST)
...
BULK_POINTS_PACKAGES = {
    "200":  {"label": "200 Points",  "amount": 200.0,  "points": 200},
    "300":  {"label": "300 Points",  "amount": 300.0,  "points": 300},
    "500":  {"label": "500 Points",  "amount": 500.0,  "points": 500},
...
async def buypoints_handler(event):
    ...
    buttons = [
        [
            ...
            Button.inline("300 Pts — $300", b"bulk_300"),
        ],
        [
            Button.inline("500 Pts — $500", b"bulk_500"),
            Button.inline("1000 Pts — $1000", b"bulk_1000"),
        ],
...
async def text_input_handler(event):
    ...
    if session.get("expecting_session_token"):
        ...
        buttons = [
            [Button.inline("💳 Buy Sub (Crypto/Points)", b"buy_crypto")],
